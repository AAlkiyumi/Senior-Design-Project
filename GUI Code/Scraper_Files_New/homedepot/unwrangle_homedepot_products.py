...
from Scraper_Files_New.homedepot import s3_read_and_write
import itertools


PRODUCT_DESTINATION_KEY = 'raw-scraping-outputs/homedepot/products/' + str(datetime.now()) + '.csv'
...
def get_products_df(SEARCH_TERM, API_KEY):
    ...
    response_df.to_csv('homedepot_product_search_response_df.csv')
