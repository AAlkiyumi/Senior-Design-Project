...
# Get the directory path for `scrape_coffee.py`
current_dir = os.path.dirname(os.path.abspath(__file__))

# Set the `Scraper_Files` directory
scraper_files_dir = os.path.join(current_dir, "..", "Scraper_Files")

# List of subfolders to add to `sys.path`
scraper_subfolders = ["Amazon", "BestBuy", "Costco", "HomeDepot", "Lowes", "Walmart"]

# Add each subfolder in `Scraper_Files` to the system path
for folder in scraper_subfolders:
    sys.path.append(os.path.join(scraper_files_dir, folder))
...
sys.path.append(os.path.join(current_dir, "..", "Scraped_Output_Formatters"))
...
def main():
    ...
    amazon_coffee_df = excelSheetToDf(str(os.path.join(current_dir, "outputs", "Reviews")) + "Amazon.com Coffee Maker Reviews " + str(datetime.now().year) + "_" + str(datetime.now().month) + "_" + str(datetime.now().day) + ".xlsx", "Sheet1")
    bestbuy_coffee_df = excelSheetToDf(str(os.path.join(current_dir, "outputs", "Reviews")) + "BestBuy.com Coffee Maker Reviews " + str(datetime.now().year) + "_" + str(datetime.now().month) + "_" + str(datetime.now().day) + ".xlsx", "Sheet1")
    walmart_coffee_df = excelSheetToDf(str(os.path.join(current_dir, "outputs", "Reviews")) + "Walmart.com Coffee Maker Reviews " + str(datetime.now().year) + "_" + str(datetime.now().month) + "_" + str(datetime.now().day) + ".xlsx", "Sheet1")
    costco_coffee_df = excelSheetToDf(str(os.path.join(current_dir, "outputs", "Reviews")) + "Costco.com Coffee Maker Reviews " + str(datetime.now().year) + "_" + str(datetime.now().month) + "_" + str(datetime.now().day) + ".xlsx", "Sheet1")
    homedepot_coffee_df = excelSheetToDf(str(os.path.join(current_dir, "outputs", "Reviews")) + "Homedepot Coffee Maker Reviews " + str(datetime.now().year) + "_" + str(datetime.now().month) + "_" + str(datetime.now().day) + ".xlsx", "Sheet1")
    lowes_coffee_df = excelSheetToDf(str(os.path.join(current_dir, "outputs", "Reviews")) + "Lowes.com Coffee Maker Reviews " + str(datetime.now().year) + "_" + str(datetime.now().month) + "_" + str(datetime.now().day) + ".xlsx", "Sheet1")
